(function () {
    ...
    function sendTileLocalImageNotification() {
        ...
        var imgSource = "ms-appx:///images/RilskiManastir.jpg";
        var imgSmallSource = "ms-appx:///images/Bulgarian-Flag.jpg";
        ...
        tileImageAttributes[0].setAttribute("alt", "100 национални туристически обекта на България");
        tileTextAttributes[0].innerText = "100 национални туристически обекта";
        ...
        squareTileImageElements[0].setAttribute("alt", "100 национални туристически обекта на България");
