...
(function () {
    ...
    ui.Pages.define(searchPageURI, {
        ...
        _generateFilters: function () {
            this._filters = [];
            this._filters.push({ results: null, text: "Брой намерени", predicate: function (item) { return true; } });
        ...
        _initializeLayout: function (listView, viewState) {
            ...
            if (viewState === appViewState.snapped) {
                ...
                document.querySelector(".titlearea .pagetitle").textContent = "Национални обекти";
                document.querySelector(".titlearea .pagesubtitle").textContent = "Резултати за “" + this._lastSearch + '”';
            }
        },
        ...
        _searchData: function (queryText) {
            ...
            if (window.Data) {
                originalResults = Data.items.createFiltered(function (item) {
                    return (item.group.title.indexOf(queryText) >= 0);
                });
            } else {
